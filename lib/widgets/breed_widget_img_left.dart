...
class BreedWidgetImageLeft extends StatelessWidget {
  ...
  const BreedWidgetImageLeft({Key? key,required this.breedName,required this.labelName,required this.labelDesc,required this.catBreed,required this.searchBtn,required this.translateBtn}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return InkResponse(
      onTap: (){
        showBreedInfoModal(context,catBreed,"assets/images/noto-v1_cat.svg",searchBtn,translateBtn);
      },
      child: Container(
